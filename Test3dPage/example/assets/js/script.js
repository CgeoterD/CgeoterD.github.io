...
helmet.model.addEventListener("load", () => {
    ...
    changeBtnTop.addEventListener('click', () => {
        ...
        cameraText.classList.remove("camera_text--active")
    })
    ...
    cameraBtn.addEventListener("click", () => {
        cameraText.classList.toggle("camera_text--active")
    })
...
let cameraBtn = document.querySelector(".Hotspot")
let cameraText = document.querySelector(".camera__text")